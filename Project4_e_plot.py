...
T2, E2, Cv2, Chi2, absM2 = read_quantities('Ising2D_e_L20_testing.txt')
T4, E4, Cv4, Chi4, absM4 = read_quantities('Ising2D_e_L40_testing.txt')
T6, E6, Cv6, Chi6, absM6 = read_quantities('Ising2D_e_L60_testing.txt')
T8, E8, Cv8, Chi8, absM8 = read_quantities('Ising2D_e_L80_testing.txt')
